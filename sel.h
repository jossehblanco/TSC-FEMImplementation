...
void assemblyK(element e,Matrix localK,Matrix &K,int num_nodos){

    //Obtiene las coordenadas del K global basadas en los nodos de cada elemento:
    // incognitas de O = Nodos, M = Nodos + num_nodos, G = Nodos + 2num_nodos, T = Nodos + 3num_nodos
    ...
    //M
    int index5 = index1 + num_nodos;
    int index6 = index2 + num_nodos;
    int index7 = index3 + num_nodos;
    int index8 = index4 + num_nodos;
    //G
    int index9  = index1 + 2*num_nodos;
    int index10 = index2 + 2*num_nodos;
    int index11 = index3 + 2*num_nodos;
    int index12 = index4 + 2*num_nodos;
    //T
    int index13 = index1 + 3*num_nodos;
    int index14 = index2 + 3*num_nodos;
    int index15 = index3 + 3*num_nodos;
    int index16 = index4 + 3*num_nodos;


    //Ajustando la posicion i, j local a la posicion i, n*j  global
...
void assemblyb(element e,Vector localb,Vector &b,int num_nodos){
